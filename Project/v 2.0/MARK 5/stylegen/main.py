...
class Output:
    ...
    def output_display(self):
        ...
        fig, ax = plt.subplots()
        ax.plot(epochs_range, loss_data, label='Loss')
        ax.set_xlabel("Iterations")
        ax.set_ylabel("Total Loss rate")
        ax.set_title('Total Loss Graph')
        ax.grid(True)
